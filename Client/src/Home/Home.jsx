                ...
                <div className="row">
                        ...
                        <div>
                            <div className="carousel-inner">
                                <div className="single-slide align-center-left animation-style-01 bg-1"
                                    style={{ backgroundImage: `url(https://lh3.googleusercontent.com/tlWox99T2HguaQ9tEB5L2DRnt6O6EZCP8xUJPBdCseHKgeSPoBvPgmvnXg3mKL_TKUfgo_SINDEa5CCz9ZqtNFutAJXtI7NU=rw)` }}>
                    ...
                    <div className="col-lg-4 col-md-4 text-center pt-xs-30">
                        <div className="li-banner">
                            <a href="#">
                                <img src="https://lh3.googleusercontent.com/4aCWFoDUVKGw-fhyZD1camNwbBx-uxqeqS3cUQDYvfKlbL7AIBLP2z3gMi5m1UGhJDGSqJHf0-68Pqzk_PpTfNe8AbRopSz5=rw-w450" alt="" />
                            </a>
                        </div>
                        <div className="li-banner mt-15 mt-sm-30 mt-xs-30">
                            <a href="#">
                                <img src="https://tinhocngoisao.cdn.vccloud.vn/wp-content/uploads/2021/06/WEB-T6-2022-2-04-600x362.png" alt="" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-4 text-center">
                            <div className="single-banner">
                                <a href="#">
                                    <img src="https://tinhocngoisao.cdn.vccloud.vn/wp-content/uploads/2022/05/WEB-T6-2022-2-01-600x362.jpg" alt="Li's Static Banner" />
                                </a>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-4 text-center pt-xs-30">
                            <div className="single-banner">
                                <a href="#">
                                    <img src="https://tinhocngoisao.cdn.vccloud.vn/wp-content/uploads/2021/06/web-laptop_fix.png" alt="Li's Static Banner" />
                                </a>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-4 text-center pt-xs-30">
                            <div className="single-banner">
                                <a href="#">
                                    <img src="https://tinhocngoisao.cdn.vccloud.vn/wp-content/uploads/2022/05/WEB-T6-2022-2-03-600x362.jpg" alt="Li's Static Banner" />
                                </a>
                            </div>
                        </div>
                    </div>
