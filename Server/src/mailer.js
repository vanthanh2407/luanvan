...
const adminEmail = 'laptopquocthanh@gmail.com' // Email

const adminPassword = 'Thanh123' // Password
...
const sendMail = (to, subject, htmlContent) => {
    ...
    const options = {
        from: '"Laptop Quốc Thành" <lapptopquocthanh@gmail.com>', // địa chỉ admin email bạn dùng để gửi
